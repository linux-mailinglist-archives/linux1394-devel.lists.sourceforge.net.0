...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id DC6DF453481
	for <lists+linux1394-devel@lfdr.de>; Tue, 16 Nov 2021 15:41:34 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <linux1394-devel-bounces@lists.sourceforge.net>)
	id 1mmze2-0006nU-1A; Tue, 16 Nov 2021 14:41:10 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2) (envelope-from
 <bounce-2287853-38-17611-linux1394-devel=lists.sourceforge.net@s15.avl4.acemsrvd.com>)
 id 1mmzdy-0006nN-Tv
 for linux1394-devel@lists.sourceforge.net; Tue, 16 Nov 2021 14:41:07 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=+79PNpYNUpbF0Uk5tC+pOXik+tsM5eCOCq7qm7VsA1Q=; b=ZkA12c3DhyC20h2hMtS6ozyzWW
 HvpxoOkjT5GQTMXXUPowbg5uI/Q43FY/JvgzB0N4J/cX0zF6vWfpQlTJM+qcGqMAicL198/i7F1g+
 gSRjuHy8FFjQQ9+IO9C1PUtfqDrOCEnjwyLi916UDZghVBMVFOhuIk3kmZz/8IscDcJk=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Archive; bh=+79PNpYNUpbF0Uk5tC+pOXik+tsM5eCOCq7qm7VsA1Q=; b=dOIrZvR/RA/d
 +YX86hpfULDG7TO7ViLqjmAh2WbLn27/BBpIrJmFBdXjQblvYQ8KLllLOBd2qj4cxspmAxgbRDQna
 Yr7NzSe4wCe5+YE/+81S4PiH72q5swEjetO6ymIqe+3/88fCqXWNJspRTa1hAiARbM3/bCrv2Um23
 hUK8c=;
Received: from s15.avl4.acemsrvd.com ([192.92.97.219])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92.3)
 id 1mmzdr-0004r9-9o
 for linux1394-devel@lists.sourceforge.net; Tue, 16 Nov 2021 14:41:06 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=dk;
 ...
 bh=+79PNpYNUpbF0Uk5tC+pOXik+tsM5eCOCq7qm7VsA1Q=;
 b=G3FVB4KOS52KYiPJK5JFGVPfs1iRDTQwej9xpvDJiLZ3JxAxKAfp6ekZGMacxGkkBj1bBc3HhyHV
 NEZkP3lcShp+q3odvqrbNbfswljXyg2bahg5fGZEvqbAwQmQiM0mnzNf11HoED38Uk7N9BeXoXTh
 yQTGQf7wBFZBygeObEM=
Received: by s15.avl4.acemsrvd.com id hif1ec2q274m for
 <linux1394-devel@lists.sourceforge.net>;
 Tue, 16 Nov 2021 14:40:38 +0000 (envelope-from
 <bounce-2287853-38-17611-linux1394-devel=lists.sourceforge.net@s15.avl4.acemsrvd.com>)
To: linux1394-devel@lists.sourceforge.net
From: "SBA Admin" <sbrugman@motorcityfunding.com>
Subject: SBA EIDL Update!
Date: Tue, 16 Nov 2021 08:38:22 -0600
MIME-Version: 1.0
...
X-mid: bGludXgxMzk0LWRldmVsQGxpc3RzLnNvdXJjZWZvcmdlLm5ldCAsIGMzOCAsIG02MCAsIHMzMw
x-virtual-mta: s15.avl4.acemsrvd.com
Feedback-ID: 2287853:activecampaign
X-250ok-CID: 2287853-38
List-Unsubscribe-Post: List-Unsubscribe=One-Click
Message-ID: <20211116144038.20885.1160700978.swift@motorcityfunding.activehosted.com>
X-Spam-Score: 1.5 (+)
...
X-Headers-End: 1mmzdr-0004r9-9o
...
Content-Type: multipart/mixed; boundary="===============7184161454617939000=="
Errors-To: linux1394-devel-bounces@lists.sourceforge.net


--===============7184161454617939000==
Content-Type: multipart/alternative;
 boundary="_=_swift-4729264466193c25eaf5a89.84721775_=_"
Content-Transfer-Encoding: 7bit


--_=_swift-4729264466193c25eaf5a89.84721775_=_
...
Unsubscribe:
http://motorcityfunding.activehosted.com/proc.php?nl=1&amp;c=38&amp;m=60&amp;s=0ad92c0c4a2ff86eed94873b1c9268b7&amp;act=unsub
...
@media only screen and (max-width: 320px) { #layout-row1011 { max-height: 0=
px!important; font-size: 0px!important; display: none!important; visibility=
: hidden!important; } #layout-row1012 img { width: 100% !important; height:=
 auto !important; max-width: 320px !important; } #layout-row1013 img { widt=
h: 100% !important; height: auto !important; max-width: 320px !important; }=
 #layout-row1015 img { width: 100% !important; height: auto !important; max=
-width: 320px !important; } #layout-row1023 img { width: 100% !important; h=
...
011 { max-height: 0px!important; font-size: 0px!important; display: none!im=
portant; visibility: hidden!important; } #layout-row1012 img { width: 100% =
!important; height: auto !important; max-width: 375px !important; } #layout=
-row1013 img { width: 100% !important; height: auto !important; max-width: =
375px !important; } #layout-row1015 img { width: 100% !important; height: a=
uto !important; max-width: 375px !important; } #layout-row1023 img { width:=
...
4px) { #layout-row1011 { max-height: 0px!important; font-size: 0px!importan=
t; display: none!important; visibility: hidden!important; } #layout-row1012=
 img { width: 100% !important; height: auto !important; max-width: 414px !i=
mportant; } #layout-row1013 img { width: 100% !important; height: auto !imp=
ortant; max-width: 380px !important; } #layout-row1015 img { width: 100% !i=
mportant; height: auto !important; max-width: 414px !important; } #layout-r=
ow1023 img { width: 100% !important; height: auto !important; max-width: 41=
...
th: 32px !important; max-width: 32px !important; }=0A}=0A@media only screen=
 and (max-width: 667px) { #layout-row1011 { max-height: 0px!important; font=
-size: 0px!important; display: none!important; visibility: hidden!important=
; } #layout-row1012 img { width: 100% !important; height: auto !important; =
max-width: 667px !important; } #layout-row1013 img { width: 100% !important=
; height: auto !important; max-width: 380px !important; } #layout-row1015 i=
mg { width: 100% !important; height: auto !important; max-width: 667px !imp=
ortant; } #layout-row1023 img { width: 100% !important; height: auto !impor=
...
actly;"><td id=3D"layout_table_3f76803662936b50838c68c0927d7949d6c10168" va=
...
r style=3D"mso-line-height-rule: exactly;"><td id=3D"layout-row-margin1011"=
...
pt;"><tr id=3D"layout-row1011" class=3D"layout layout-row widget _widget_sp=
acer " style=3D"mso-line-height-rule: exactly;"><td id=3D"layout-row-paddin=
g1011" valign=3D"top"=0Astyle=3D"mso-line-height-rule: exactly;"><table wid=
...
ine-height-rule: exactly;"><td id=3D"layout-row-margin1012" valign=3D"top" =
...
ayout-row1012" class=3D"layout layout-row widget _widget_picture " align=3D=
"center" style=3D"mso-line-height-rule: exactly;"><td id=3D"layout-row-padd=
ing1012" valign=3D"top" style=3D"mso-line-height-rule: exactly;"><table wid=
th=3D"100%" border=3D"0" cellpadding=3D"0" cellspacing=3D"0" style=3D"-ms-t=
ext-size-adjust: auto; -webkit-text-size-adjust: 100%; border-collapse: col=
lapse; font-size: 14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-r=
...
8/5ed7148d-1798-4506-a900-35ec4edba52c.png?r=3D1406948735" alt=3D"" width=
...
; opacity: 1; max-width: 100%;"></td>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A=
 ...
 id=3D"layout-row-margin1010" valign=3D"top" style=3D"mso-line-height-rule:=
...
w1010" class=3D"layout layout-row widget _widget_text style1010" style=3D"m=
so-line-height-rule: exactly; margin: 0; padding: 0; background-color: #244=
df0;"><td id=3D"layout-row-padding1010" valign=3D"top" style=3D"mso-line-he=
...
: 0pt;"><tr style=3D"mso-line-height-rule: exactly;"><td id=3D"text_div859"=
...
=3D"true" data-ac-inline=3D"false"> #text_div859, #text_div859 div { line-h=
eight: 140% !important; };=0A</style>=0A<![endif]--></td>=0A</tr>=0A</table=
>=0A</td>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A<tr style=3D"mso-line-height=
-rule: exactly;"><td id=3D"layout-row-margin1023" valign=3D"top" style=3D"m=
...
023" class=3D"layout layout-row widget _widget_picture " align=3D"left" sty=
le=3D"mso-line-height-rule: exactly;"><td id=3D"layout-row-padding1023" val=
...
ad-4389-a62e-b7bdcea92aec.png?r=3D1516026458" alt=3D"" width=3D"650" style=
...
row-margin1013" valign=3D"top" style=3D"mso-line-height-rule: exactly;"><ta=
...
o-table-rspace: 0pt;"><tr id=3D"layout-row1013" class=3D"layout layout-row =
widget _widget_picture " align=3D"center" style=3D"mso-line-height-rule: ex=
actly;"><td id=3D"layout-row-padding1013" valign=3D"top" style=3D"mso-line-=
...
g?r=3D1976524700" alt=3D"" width=3D"380" style=3D"display: block; border: n=
...
-line-height-rule: exactly;"><td id=3D"layout-row-margin1014" valign=3D"top=
...
-rspace: 0pt;"><tr id=3D"layout-row1014" class=3D"layout layout-row widget =
_widget_text style1014" style=3D"mso-line-height-rule: exactly; margin: 0; =
padding: 0; background-color: #244df0;"><td id=3D"layout-row-padding1014" v=
...
le: exactly;"><td=0Aid=3D"text_div863" class=3D"td_text td_block" valign=3D=
...
</tr>=0A<tr id=3D"layout-row1018" class=3D"layout layout-row clear-this " s=
tyle=3D"mso-line-height-rule: exactly;"><td id=3D"layout-row-padding1018" v=
...
;"><tr style=3D"mso-line-height-rule: exactly;"><td id=3D"layout_table_8011=
0ba85566e47d1bf25a7850c2dbdf1ce09809" valign=3D"top" width=3D"325" style=3D=
...
w-margin1015" valign=3D"top" style=3D"mso-line-height-rule:=0Aexactly;"><ta=
ble width=3D"100%" border=3D"0" cellpadding=3D"0" cellspacing=3D"0" style=
=3D"-ms-text-size-adjust: auto; -webkit-text-size-adjust: 100%; border-coll=
apse: collapse; font-size: 14px; min-width: 100%; mso-table-lspace: 0pt; ms=
o-table-rspace: 0pt;"><tr id=3D"layout-row1015" class=3D"layout layout-row =
widget _widget_picture " align=3D"center" style=3D"mso-line-height-rule: ex=
actly;"><td id=3D"layout-row-padding1015" valign=3D"top" style=3D"mso-line-=
height-rule: exactly;"><table width=3D"100%" border=3D"0" cellpadding=3D"0"=
 cellspacing=3D"0" style=3D"-ms-text-size-adjust: auto; -webkit-text-size-a=
djust: 100%; border-collapse: collapse; font-size: 14px; min-width: 100%; m=
so-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr style=3D"mso-line-height-=
...
=3D2063418966" alt=3D"" width=3D"203"=0Astyle=3D"display: block; border: no=
ne; outline: none; width: 203px; opacity: 1; max-width: 100%;"></td>=0A</tr=
>=0A</table>=0A</td>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A</table>=0A</td>=
=0A<td id=3D"layout_table_d52e4833f6dec554357ef25b21cf294c447e8ff1" valign=
...
: exactly;"><td id=3D"layout-row-margin1016" valign=3D"top" style=3D"mso-li=
...
e: 14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><t=
r id=3D"layout-row1016" class=3D"layout layout-row widget _widget_text styl=
e1016" style=3D"mso-line-height-rule: exactly; margin: 0; padding: 0;"><td =
id=3D"layout-row-padding1016" valign=3D"top"=0Astyle=3D"mso-line-height-rul=
...
eight-rule: exactly;"><td id=3D"text_div865" class=3D"td_text td_block" val=
...
;"><td id=3D"layout-row-margin1017" valign=3D"top" style=3D"mso-line-height=
...
min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr id=3D"l=
ayout-row1017" class=3D"layout layout-row widget _widget_button style1017" =
style=3D"mso-line-height-rule: exactly; background-color: #244df0;"><td id=
=3D"layout-row-padding1017" valign=3D"top" style=3D"mso-line-height-rule: e=
...
hbg=3D=3D&sig=3DEpb9fDRFNr1Wfb2FNFpkQncciuz3B5N7ZhRt5uZ6Q8sZ&iat=3D16370736=
38&a=3D%7C%7C225362583%7C%7C&account=3Dmotorcityfunding%2Eactivehosted%2Eco=
m&email=3DrcnACfXAw2TQUyfpj7YMwBdIU0DsLaDSPK6rhDqV%2BUXVt3QtV0xSM9W6AkIVKsA=
f&s=3D0ad92c0c4a2ff86eed94873b1c9268b7&i=3D38A60A1A111" style=3D"v-text-anc=
hor:middle; width:130px; height:60px; font-weight: bold;" arcsize=3D"6%" st=
rokecolor=3D"#B5B5B5" strokeweight=3D"1pt" fillcolor=3D"#ff1414" o:button=
...
y5jb20lMkZzYnJ1Z21hbg=3D=3D&sig=3DEpb9fDRFNr1Wfb2FNFpkQncciuz3B5N7ZhRt5uZ6Q=
8sZ&iat=3D1637073638&a=3D%7C%7C225362583%7C%7C&account=3Dmotorcityfunding%2=
Eactivehosted%2Ecom&email=3DrcnACfXAw2TQUyfpj7YMwBdIU0DsLaDSPK6rhDqV%2BUXVt=
3QtV0xSM9W6AkIVKsAf&s=3D0ad92c0c4a2ff86eed94873b1c9268b7&i=3D38A60A1A111" s=
tyle=3D"margin: 0; outline: none; padding: 12px; color: #ffffff; background=
: #ff1414; background-color: #ff1414; border: 1px solid #B5B5B5; border-rad=
ius: 3px; font-family: Arial; font-size: 14px; display: inline-block; line-=
height: 1.1; text-align: center; text-decoration: none; mso-hide: all;"> <s=
pan style=3D"color:#ffffff;font-family:Arial;font-size:14px;font-weight: bo=
ld;"> APPLY NOW </span> </a> </div>=0A=0A</td>=0A</tr>=0A</table>=0A</td>=
=0A</tr>=0A</table>=0A</td>=0A</tr>=0A<tr style=3D"mso-line-height-rule: ex=
actly;"><td id=3D"layout-row-margin1019" valign=3D"top" style=3D"mso-line-h=
...
=3D"layout-row1019" class=3D"layout layout-row widget _widget_text style101=
9" style=3D"mso-line-height-rule: exactly; margin: 0; padding: 0;"><td id=
=3D"layout-row-padding1019" valign=3D"top" style=3D"mso-line-height-rule: e=
xactly; padding: 5px;"><table width=3D"100%" border=3D"0" cellpadding=3D"0"=
 cellspacing=3D"0" style=3D"-ms-text-size-adjust: auto; -webkit-text-size-a=
djust: 100%; border-collapse: collapse; font-size: 14px; min-width: 100%; m=
so-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr style=3D"mso-line-height-=
rule: exactly;"><td id=3D"text_div867" class=3D"td_text td_block" valign=3D=
"top" align=3D"left"=0Awidth=3D"630" style=3D"mso-line-height-rule: exactly=
; margin: 0; outline: none; padding: 0; color: inherit; font-size: 12px; fo=
nt-weight: inherit; line-height: 1; text-decoration: inherit; font-family: =
arial;"> <div style=3D"margin: 0; outline: none; padding: 0; color: inherit=
; font-size: 14px; font-weight: inherit; line-height: inherit; text-decorat=
ion: inherit;"> <div style=3D"margin: 0; outline: none; padding: 0; color: =
inherit; font-size: inherit; font-weight: inherit; line-height: inherit; te=
xt-decoration: inherit;"> <span style=3D"color: #244df0; font-size: inherit=
; font-weight: inherit; line-height: inherit; text-decoration: inherit;" cl=
ass=3D""><br><span style=3D"color: inherit; font-size: inherit; font-weight=
: inherit; line-height: inherit; text-decoration: inherit; margin: 0;"><div=
...
font-family: arial; font-style: normal;=0Atext-align: -webkit-left;"><span =
style=3D"color: inherit; font-size: inherit; font-weight: inherit; line-hei=
ght: inherit; text-decoration: inherit; font-family: arial;">If you have an=
y questions please do not hesitate to call.=C2=A0 We pride ourselves on alw=
ays being available to our clients.</span></div>=0A<div style=3D"margin: 0;=
 outline: none; padding: 0; color: inherit; font-size: inherit; font-weight=
: 400; line-height: inherit; text-decoration: inherit; font-family: arial; =
font-style: normal; text-align: -webkit-left;"><br style=3D""></div>=0A<div=
 style=3D"margin: 0; outline: none; padding: 0; color: inherit; font-size: =
inherit; font-weight: 400; line-height: inherit; text-decoration: inherit; =
font-family: arial; font-style: normal; text-align: -webkit-left;"><span st=
yle=3D"color: inherit; font-size: inherit; font-weight: inherit; line-heigh=
t: inherit; text-decoration: inherit; font-family: arial;">Sincerely,</span=
></div>=0A<div style=3D"margin: 0; outline: none; padding: 0; color: inheri=
t; font-size: inherit; font-weight: 400; line-height: inherit; text-decorat=
ion: inherit; font-family: arial; font-style: normal; text-align: -webkit-l=
eft;"><br style=3D""></div>=0A<div style=3D"margin: 0; outline: none; paddi=
...
ext-align: -webkit-left;"><span style=3D"color: inherit; font-size: inherit=
; font-weight: inherit; line-height: inherit; text-decoration: inherit;"><s=
pan style=3D"color: inherit; font-size: inherit; font-weight: bold; line-he=
ight: inherit; text-decoration: inherit; font-family: arial;">Samuel Brugma=
n</span><span style=3D"color: inherit; font-size: inherit; font-weight: inh=
erit; line-height: inherit; text-decoration: inherit; font-family: arial;">=
 </span><span style=3D"color: inherit; font-size: inherit; font-weight: bol=
d; line-height: inherit; text-decoration: inherit; font-family: arial;">| <=
/span><span style=3D"color: inherit; font-size: inherit; font-weight: inher=
it; line-height: inherit; text-decoration: inherit; font-family: arial;">Fu=
nding Manager</span></span></div>=0A</span></span></div>=0A </div>=0A</td>=
=0A</tr>=0A</table>=0A</td>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A<tr id=3D"=
layout-row1022" class=3D"layout layout-row clear-this " style=3D"mso-line-h=
eight-rule: exactly;"><td id=3D"layout-row-padding1022" valign=3D"top" styl=
...
o-line-height-rule: exactly;"><td id=3D"layout_table_e96a81c856abc0eeda1518=
2ff2e944dfbcff3792" valign=3D"top" width=3D"325" style=3D"mso-line-height-r=
...
le=3D"mso-line-height-rule: exactly;"><td id=3D"layout-row-margin1020" vali=
gn=3D"top" style=3D"mso-line-height-rule:=0Aexactly; padding: 5px;"><table =
...
; mso-table-rspace: 0pt;"><tr id=3D"layout-row1020" class=3D"layout layout-=
row widget _widget_text style1020" style=3D"mso-line-height-rule: exactly; =
margin: 0; padding: 0; background-color: #244df0;"><td id=3D"layout-row-pad=
ding1020" valign=3D"top" style=3D"mso-line-height-rule: exactly; background=
-color: #244df0; padding: 5px;"><table width=3D"100%" border=3D"0" cellpadd=
...
e-height-rule: exactly;"><td id=3D"text_div868" class=3D"td_text td_block" =
valign=3D"top" align=3D"left" width=3D"305" style=3D"mso-line-height-rule: =
exactly; margin: 0;=0Aoutline: none; padding: 0; color: inherit; font-size:=
...
: inherit; font-size: inherit; font-weight: inherit; line-height: inherit; =
text-decoration: inherit;"><div style=3D"margin: 0; outline: none; padding:=
 0; color: inherit; font-size: 16px; font-weight: inherit; line-height: inh=
erit; text-decoration: inherit; text-align: center;"><span style=3D"color: =
#53ff14; font-size: inherit; font-weight: bold; line-height: inherit; text-=
decoration: inherit; font-family: arial; text-align: inherit;" class=3D"">M=
otor City Funding</span></div>=0A <div style=3D"margin: 0; outline: none; p=
...
rit; text-decoration: inherit; font-family: arial; text-align: inherit;" cl=
ass=3D"">3000 Town Center</span></div>=0A<span style=3D"color: #ffffff; fon=
t-size: 14px; font-weight: inherit; line-height: inherit; text-decoration: =
inherit; font-family: arial; font-style: normal;" class=3D""><div style=3D"=
...
lign: center;"><span style=3D"color: inherit; font-size: inherit; font-weig=
ht: inherit; line-height: inherit; text-decoration: inherit; font-family: a=
rial; text-align: inherit;">Southfield, MI 48076</span></div>=0A<div style=
...
t_table_85f0a3c04460006dc73e9714328cde83a54de4d2" valign=3D"top" width=3D"3=
...
=3D"layout-row-margin1021" valign=3D"top" style=3D"mso-line-height-rule: ex=
...
1021" class=3D"layout layout-row widget _widget_button style1021" style=3D"=
mso-line-height-rule: exactly; background-color: #244df0;"><td id=3D"layout=
-row-padding1021" valign=3D"top"=0Astyle=3D"mso-line-height-rule: exactly; =
...
=3D1&c=3D38&m=3D60&s=3D0ad92c0c4a2ff86eed94873b1c9268b7&l=3Dopen&account=3D=
...
=3D1&c=3D38&m=3D60&s=3D0ad92c0c4a2ff86eed94873b1c9268b7&act=3Dunsub" style=
