...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 2CA5A43BC97
	for <lists+linux1394-devel@lfdr.de>; Tue, 26 Oct 2021 23:43:03 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.92.3)
	(envelope-from <linux1394-devel-bounces@lists.sourceforge.net>)
	id 1mfUDa-0007sC-JM; Tue, 26 Oct 2021 21:42:50 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92.3)
 (envelope-from
 <bounce-2287853-15-17611-linux1394-devel=lists.sourceforge.net@s14.avl3.acemsrvc.com>)
 id 1mfUDD-0007rN-UV
 for linux1394-devel@lists.sourceforge.net; Tue, 26 Oct 2021 21:42:28 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=9uLm1G7WkLWUAzO6Rd5tWUNgEaHZFCzm89KJ8Nn607A=; b=lrBVjWV0wEGjZPtldZN/s6pM6r
 jWTnq0OKlYYiXZ0KQaWJ7jQouURx254QAQgCmdhT7hz0lHccxatoVBm74vyYZNVKmf2Fz32eeVRaN
 Abf7IIMAs9f4QAdh9SZyCmjVFtuNOPTh2TNzNPtgmu8Mq7E45C9H0LOfEGHHF1UzzmK0=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Archive; bh=9uLm1G7WkLWUAzO6Rd5tWUNgEaHZFCzm89KJ8Nn607A=; b=VsNb5YLwOBNm
 SJmX+lD274KWaVK/FLdDA8p3489+3xDbhphlpHyHC01CAryFg4Gj2arGwodTtWURkgJa4F5ZCfLa9
 vqkouoHMMN1X1vaSWyokwK1iA0CgXL/kFe+AmrCmlLxTZ6XS2wZQbS3shtL4eG3ycb9N86nHWu5eQ
 mTLzk=;
Received: from s14.avl3.acemsrvc.com ([192.92.97.208])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92.3)
 id 1mfUCj-0004aX-Ey
 for linux1394-devel@lists.sourceforge.net; Tue, 26 Oct 2021 21:42:27 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=dk;
 ...
 bh=9uLm1G7WkLWUAzO6Rd5tWUNgEaHZFCzm89KJ8Nn607A=;
 b=mLCmYvEOisntwp1zGiX/gBNXqxsyCCuEurMPHdSqqxplu7bet1q2Ja6tlvfMTCtixw5nQ+mus+lE
 VuQoLbSg/fhBz8ptDAFQlaQSY5QcicwNKHcdtLGcnGq6p7gbUn5Z93QOaLJu5LPEmMGmumdSXAQK
 LFMxA9oVK5ELKOvW09U=
Received: by s14.avl3.acemsrvc.com id hf1r1k2t56gt for
 <linux1394-devel@lists.sourceforge.net>;
 Tue, 26 Oct 2021 21:41:46 +0000 (envelope-from
 <bounce-2287853-15-17611-linux1394-devel=lists.sourceforge.net@s14.avl3.acemsrvc.com>)
To: linux1394-devel@lists.sourceforge.net
From: "SBA Admin" <sbrugman@motorcityfunding.com>
Subject: SBA Still Accepting Applications for the EIDL!
Date: Tue, 26 Oct 2021 16:38:38 -0500
MIME-Version: 1.0
...
X-mid: bGludXgxMzk0LWRldmVsQGxpc3RzLnNvdXJjZWZvcmdlLm5ldCAsIGMxNSAsIG0yMSAsIHMxMA
x-virtual-mta: s14.avl3.acemsrvc.com
Feedback-ID: 2287853:activecampaign
X-250ok-CID: 2287853-15
List-Unsubscribe-Post: List-Unsubscribe=One-Click
Message-ID: <20211026214146.26515.1228262502.swift@motorcityfunding.activehosted.com>
X-Headers-End: 1mfUCj-0004aX-Ey
...
Content-Type: multipart/mixed; boundary="===============0154429016500491918=="
Errors-To: linux1394-devel-bounces@lists.sourceforge.net


--===============0154429016500491918==
Content-Type: multipart/alternative;
 boundary="_=_swift-19073707536178755e95df51.82832686_=_"
Content-Transfer-Encoding: 7bit


--_=_swift-19073707536178755e95df51.82832686_=_
...
Unsubscribe:
http://motorcityfunding.activehosted.com/proc.php?nl=1&amp;c=15&amp;m=21&amp;s=0ad92c0c4a2ff86eed94873b1c9268b7&amp;act=unsub
...
@media only screen and (max-width: 320px) { #layout-row472 img { width: 100=
% !important; height: auto !important; max-width: 320px !important; } #layo=
ut-row474 img { width: 100% !important; height: auto !important; max-width:=
 320px !important; } #layout-row482 img { width: 100% !important; height: a=
uto !important; max-width: 320px !important; } #layout-row487 img { width: =
100% !important; height: auto !important; max-width: 320px !important; } #l=
ayout-row492 img { width: 100% !important; height: auto !important; max-wid=
th: 320px !important; } #layout-row497 img { width: 100% !important; height=
: auto !important; max-width: 320px !important; } #layout-row501 img { widt=
h: 100% !important; height: auto !important; max-width: 320px !important; }=
 #layout-row502 img { width: 100% !important; height: auto !important; max-=
...
only screen and (max-width: 375px) { #layout-row472 img { width: 100% !impo=
rtant; height: auto !important; max-width: 375px !important; } #layout-row4=
74 img { width: 100% !important; height: auto !important; max-width: 375px =
!important; } #layout-row482 img { width: 100% !important; height: auto !im=
portant; max-width: 375px !important; } #layout-row487 img { width: 100% !i=
mportant; height: auto !important; max-width: 339px !important; } #layout-r=
ow492 img { width: 100% !important; height: auto !important; max-width: 375=
px !important; } #layout-row497 img { width: 100% !important; height: auto =
!important; max-width: 375px !important; } #layout-row501 img { width: 100%=
 !important; height: auto !important; max-width: 375px !important; } #layou=
t-row502 img { width: 100% !important; height: auto !important; max-width: =
...
reen and (max-width: 414px) { #layout-row472 img { width: 100% !important; =
height: auto !important; max-width: 414px !important; } #layout-row474 img =
{ width: 100% !important; height: auto !important; max-width: 414px !import=
ant; } #layout-row482 img { width: 100% !important; height: auto !important=
; max-width: 414px !important; } #layout-row487 img { width: 100% !importan=
t; height: auto !important; max-width: 339px !important; } #layout-row492 i=
mg { width: 100% !important; height: auto !important; max-width: 414px !imp=
ortant; } #layout-row497 img { width: 100% !important; height: auto !import=
ant; max-width: 414px !important; } #layout-row501 img { width: 100% !impor=
tant; height: auto !important; max-width: 414px !important; } #layout-row50=
...
d (max-width: 667px) { #layout-row472 img { width: 100% !important; height:=
 auto !important; max-width: 667px !important; } #layout-row474 img { width=
: 100% !important; height: auto !important; max-width: 434px !important; } =
#layout-row482 img { width: 100% !important; height: auto !important; max-w=
idth: 667px !important; } #layout-row487 img { width: 100% !important; heig=
ht: auto !important; max-width: 339px !important; } #layout-row492 img { wi=
dth: 100% !important; height: auto !important; max-width: 667px !important;=
 } #layout-row497 img { width: 100% !important; height: auto !important; ma=
x-width: 667px !important; } #layout-row501 img { width: 100% !important; h=
eight: auto !important; max-width: 667px !important; } #layout-row502 img {=
...
d id=3D"layout_table_5785dbfcb87d97a61322f10808d16943dc060c92" valign=3D"to=
...
: exactly; background-color: #ffffff;"><td id=3D"layout-row-margin472" vali=
...
0pt; mso-table-rspace: 0pt;"><tr id=3D"layout-row472" class=3D"layout layou=
t-row widget _widget_picture " align=3D"center" style=3D"mso-line-height-ru=
le: exactly;"><td id=3D"layout-row-padding472" valign=3D"top" style=3D"mso-=
...
//motorcityfunding.img-us6.com/admin/mcf.png?r=3D2016596679" alt=3D"" width=
...
ground-color: #ffffff;"><td id=3D"layout-row-margin473" valign=3D"top" styl=
...
space: 0pt; mso-table-rspace: 0pt;"><tr id=3D"layout-row473" class=3D"layou=
t layout-row widget _widget_text style473" style=3D"mso-line-height-rule: e=
xactly; margin: 0; padding: 0; background-color: #244df0;"><td id=3D"layout=
-row-padding473" valign=3D"top" style=3D"mso-line-height-rule: exactly; bac=
...
=3D"mso-line-height-rule: exactly;"><td id=3D"text_div403" class=3D"td_text=
...
margin502" valign=3D"top" style=3D"mso-line-height-rule: exactly; backgroun=
...
able-lspace: 0pt; mso-table-rspace: 0pt;"><tr id=3D"layout-row502" class=3D=
"layout layout-row widget _widget_picture " align=3D"left" style=3D"mso-lin=
e-height-rule: exactly;"><td id=3D"layout-row-padding502" valign=3D"top" st=
...
bdcea92aec.png?id=3D7317681?r=3D406979873" alt=3D"" width=3D"650" style=3D"=
...
fffff;"><td id=3D"layout-row-margin474" valign=3D"top" style=3D"mso-line-he=
...
id=3D"layout-row474" class=3D"layout layout-row widget _widget_picture " al=
ign=3D"center" style=3D"mso-line-height-rule: exactly;"><td id=3D"layout-ro=
w-padding474" valign=3D"top" style=3D"mso-line-height-rule: exactly;"><tabl=
...
dmin/unnamed.jpg?r=3D621747745" alt=3D"" width=3D"434" style=3D"display: bl=
...
d=3D"layout-row-margin503" valign=3D"top" style=3D"mso-line-height-rule: ex=
...
row503" class=3D"layout layout-row widget _widget_spacer " style=3D"mso-lin=
e-height-rule: exactly;"><td id=3D"layout-row-padding503" valign=3D"top" st=
yle=3D"mso-line-height-rule: exactly;"><table width=3D"100%" border=3D"0" c=
ellpadding=3D"0" cellspacing=3D"0" style=3D"-ms-text-size-adjust: auto; -we=
bkit-text-size-adjust: 100%; border-collapse: collapse; font-size: 14px; mi=
n-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr style=3D"=
...
actly; background-color: #ffffff;"><td id=3D"layout-row-margin476" valign=
...
; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr id=3D"layout-row476" c=
lass=3D"layout layout-row widget _widget_text style476" style=3D"mso-line-h=
eight-rule: exactly; margin: 0; padding: 0;"><td id=3D"layout-row-padding47=
...
=3D"text_div406"=0Aclass=3D"td_text td_block" valign=3D"top" align=3D"left"=
...
layout-row-margin504" valign=3D"top" style=3D"mso-line-height-rule: exactly=
...
"><tr id=3D"layout-row504" class=3D"layout layout-row widget _widget_button=
 style504" style=3D"mso-line-height-rule: exactly; background-color: #244df=
0;"><td id=3D"layout-row-padding504" valign=3D"top" style=3D"mso-line-heigh=
...
ZzYnJ1Z21hbg=3D=3D&sig=3DChWyjhaYqAPfQwffD4yUoaPSBicyKKUTRYMF9n15nz4a&iat=
=3D1635284506&a=3D%7C%7C225362583%7C%7C&account=3Dmotorcityfunding%2Eactive=
hosted%2Ecom&email=3DrcnACfXAw2TQUyfpj7YMwBdIU0DsLaDSPK6rhDqV%2BUXVt3QtV0xS=
M9W6AkIVKsAf&s=3D0ad92c0c4a2ff86eed94873b1c9268b7&i=3D15A21A1A42" style=3D"=
...
3dy5wbWZ1cy5jb20lMkZzYnJ1Z21hbg=3D=3D&sig=3DChWyjhaYqAPfQwffD4yUoaPSBicyKKU=
TRYMF9n15nz4a&iat=3D1635284506&a=3D%7C%7C225362583%7C%7C&account=3Dmotorcit=
yfunding%2Eactivehosted%2Ecom&email=3DrcnACfXAw2TQUyfpj7YMwBdIU0DsLaDSPK6rh=
DqV%2BUXVt3QtV0xSM9W6AkIVKsAf&s=3D0ad92c0c4a2ff86eed94873b1c9268b7&i=3D15A2=
1A1A42" style=3D"margin: 0; outline: none; padding: 12px; color: #ffffff; b=
...
-rule: exactly; background-color: #ffffff;"><td id=3D"layout-row-margin501"=
...
ace: 0pt; mso-table-rspace: 0pt;"><tr id=3D"layout-row501" class=3D"layout =
layout-row widget _widget_picture " align=3D"left" style=3D"mso-line-height=
-rule: exactly;"><td id=3D"layout-row-padding501" valign=3D"top" style=3D"m=
...
ec.png?id=3D7317681?r=3D1231025261" alt=3D"" width=3D"650" style=3D"display=
...
<td id=3D"layout-row-margin500" valign=3D"top" style=3D"mso-line-height-rul=
...
pace: 0pt;"><tr id=3D"layout-row500" class=3D"layout layout-row widget _wid=
get_text style500" style=3D"mso-line-height-rule: exactly; margin: 0; paddi=
ng: 0; background-color: #244df0;"><td id=3D"layout-row-padding500" valign=
...
e-lspace: 0pt; mso-table-rspace: 0pt;"><tr=0Astyle=3D"mso-line-height-rule:=
 exactly;"><td id=3D"text_div425" class=3D"td_text td_block" valign=3D"top"=
...
layout-row498" class=3D"layout layout-row clear-this " style=3D"mso-line-he=
ight-rule: exactly; background-color: #ffffff;"><td id=3D"layout-row-paddin=
g498" valign=3D"top" style=3D"mso-line-height-rule: exactly; background-col=
...
ctly;"><td id=3D"layout_table_b8fdb4e1fa3bff549b3c4df362e5e932ef6e51f6" val=
...
ule: exactly;"><td=0Aid=3D"layout-row-margin497" valign=3D"top" style=3D"ms=
...
100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr id=3D"layout-row49=
7" class=3D"layout layout-row widget _widget_picture " align=3D"center" sty=
le=3D"mso-line-height-rule: exactly;"><td id=3D"layout-row-padding497" vali=
...
7004-40ca-ba8e-9b2b418af77c.png?r=3D1133689893" alt=3D"" width=3D"238" styl=
e=3D"display: block; border: none; outline: none; width: 238px; opacity: 1;=
 max-width: 100%;"></td>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A</table>=0A</=
td>=0A</tr>=0A</table>=0A</td>=0A<td id=3D"layout_table_7a1b1d22b988d931245=
9d7f1406e98a280c821bd" valign=3D"top" width=3D"325" style=3D"mso-line-heigh=
...
auto; -webkit-text-size-adjust: 100%; border-collapse: collapse; font-size:=
 14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr =
style=3D"mso-line-height-rule: exactly;"><td id=3D"layout-row-margin499" va=
...
-size: 14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;=
"><tr id=3D"layout-row499" class=3D"layout layout-row widget _widget_spacer=
 " style=3D"mso-line-height-rule: exactly;"><td id=3D"layout-row-padding499=
...
ight-rule: exactly;"><td id=3D"layout-row-margin496" valign=3D"top" style=
...
; font-size: 14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace=
: 0pt;"><tr id=3D"layout-row496" class=3D"layout layout-row widget _widget_=
text style496" style=3D"mso-line-height-rule: exactly; margin: 0; padding: =
0;"><td id=3D"layout-row-padding496" valign=3D"top" style=3D"mso-line-heigh=
...
e-height-rule: exactly;"><td id=3D"text_div422" class=3D"td_text td_block" =
...
t-rule: exactly; background-color: #ffffff;"><td id=3D"layout-row-margin495=
...
ow495" class=3D"layout layout-row widget _widget_text style495" style=3D"ms=
o-line-height-rule: exactly; margin: 0; padding: 0; background-color: #244d=
f0;"><td id=3D"layout-row-padding495" valign=3D"top" style=3D"mso-line-heig=
...
ize-adjust: auto; -webkit-text-size-adjust: 100%; border-collapse: collapse=
; font-size: 14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace=
: 0pt;"><tr=0Astyle=3D"mso-line-height-rule: exactly;"><td id=3D"text_div42=
...
/td>=0A</tr>=0A<tr id=3D"layout-row493" class=3D"layout layout-row clear-th=
is " style=3D"mso-line-height-rule: exactly; background-color: #ffffff;"><t=
d id=3D"layout-row-padding493" valign=3D"top" style=3D"mso-line-height-rule=
: exactly; background-color: #ffffff;"><table width=3D"100%" border=3D"0" c=
ellpadding=3D"0" cellspacing=3D"0" style=3D"-ms-text-size-adjust: auto; -we=
bkit-text-size-adjust: 100%; border-collapse: collapse; font-size: 14px; mi=
n-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr style=3D"=
mso-line-height-rule: exactly;"><td id=3D"layout_table_350131f391faf05088a9=
445ae22f14918baaef57" valign=3D"top" width=3D"325" style=3D"mso-line-height=
...
tyle=3D"mso-line-height-rule: exactly;"><td=0Aid=3D"layout-row-margin494" v=
...
;"><tr id=3D"layout-row494" class=3D"layout layout-row widget _widget_space=
r " style=3D"mso-line-height-rule: exactly;"><td id=3D"layout-row-padding49=
...
eight-rule: exactly;"><td id=3D"layout-row-margin491" valign=3D"top" style=
=3D"mso-line-height-rule: exactly; padding: 5px;"><table width=3D"100%" bor=
der=3D"0" cellpadding=3D"0" cellspacing=3D"0" style=3D"-ms-text-size-adjust=
: auto; -webkit-text-size-adjust: 100%; border-collapse: initial !important=
; font-size: 14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace=
: 0pt;"><tr id=3D"layout-row491" class=3D"layout layout-row widget _widget_=
text style491" style=3D"mso-line-height-rule: exactly; margin: 0; padding: =
0;"><td id=3D"layout-row-padding491" valign=3D"top" style=3D"mso-line-heigh=
t-rule: exactly; padding: 5px;"><table width=3D"100%" border=3D"0" cellpadd=
ing=3D"0" cellspacing=3D"0" style=3D"-ms-text-size-adjust: auto; -webkit-te=
xt-size-adjust: 100%; border-collapse: collapse; font-size: 14px; min-width=
: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr style=3D"mso-lin=
e-height-rule: exactly;"><td id=3D"text_div418" class=3D"td_text td_block" =
valign=3D"top" align=3D"left"=0Awidth=3D"305" style=3D"mso-line-height-rule=
: exactly; margin: 0; outline: none; padding: 0; color: inherit; font-size:=
 12px; font-weight: inherit; line-height: 1; text-decoration: inherit; font=
-family: arial;"> <div style=3D"margin: 0; outline: none; padding: 0; color=
...
84d5faea4a11d101d4784208c516787c304a000" valign=3D"top" width=3D"325" style=
...
-row-margin492" valign=3D"top" style=3D"mso-line-height-rule: exactly;"><ta=
ble width=3D"100%" border=3D"0" cellpadding=3D"0" cellspacing=3D"0" style=
=3D"-ms-text-size-adjust: auto; -webkit-text-size-adjust: 100%; border-coll=
apse: collapse; font-size: 14px; min-width: 100%; mso-table-lspace: 0pt; ms=
o-table-rspace: 0pt;"><tr id=3D"layout-row492" class=3D"layout layout-row w=
idget _widget_picture " align=3D"left" style=3D"mso-line-height-rule: exact=
ly;"><td id=3D"layout-row-padding492" valign=3D"top" style=3D"mso-line-heig=
...
=3D7317507?r=3D629514391" alt=3D"" width=3D"318" style=3D"display: block; b=
order: none; outline: none; width: 318px; opacity: 1; max-width: 100%;"></t=
d>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A</table>=
=0A</td>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A<tr style=3D"mso-line-height-=
rule: exactly; background-color: #ffffff;"><td id=3D"layout-row-margin490" =
...
490" class=3D"layout layout-row widget _widget_text style490" style=3D"mso-=
line-height-rule: exactly; margin: 0; padding: 0; background-color: #244df0=
;"><td id=3D"layout-row-padding490" valign=3D"top" style=3D"mso-line-height=
...
font-size: 14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: =
0pt;"><tr=0Astyle=3D"mso-line-height-rule: exactly;"><td id=3D"text_div417"=
...
table>=0A</td>=0A</tr>=0A<tr id=3D"layout-row488" class=3D"layout layout-ro=
w clear-this " style=3D"mso-line-height-rule: exactly; background-color: #f=
fffff;"><td id=3D"layout-row-padding488" valign=3D"top" style=3D"mso-line-h=
...
er=3D"0" cellpadding=3D"0" cellspacing=3D"0" style=3D"-ms-text-size-adjust:=
 auto; -webkit-text-size-adjust: 100%; border-collapse: collapse; font-size=
: 14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr=
 style=3D"mso-line-height-rule: exactly;"><td id=3D"layout_table_0b86ebe523=
5b4bb112c5982fe54fbc364c394524" valign=3D"top" width=3D"325" style=3D"mso-l=
...
rgin487" valign=3D"top" style=3D"mso-line-height-rule: exactly;"><table wid=
...
space: 0pt;"><tr id=3D"layout-row487" class=3D"layout layout-row widget _wi=
dget_picture " align=3D"center" style=3D"mso-line-height-rule: exactly;"><t=
d id=3D"layout-row-padding487" valign=3D"top" style=3D"mso-line-height-rule=
...
74?r=3D1523090969" alt=3D"" width=3D"200" style=3D"display: block; border: =
none; outline: none; width: 200px; opacity: 1; max-width: 100%;"></td>=0A</=
tr>=0A</table>=0A</td>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A</table>=0A</td=
>=0A<td id=3D"layout_table_fa4bc2167f1d534708fc62d23f7cd51f84dc863b" valign=
...
: exactly;"><td id=3D"layout-row-margin489" valign=3D"top" style=3D"mso-lin=
...
-adjust: 100%; border-collapse: collapse; font-size: 14px; min-width: 100%;=
 mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr id=3D"layout-row489" cl=
ass=3D"layout layout-row widget _widget_spacer " style=3D"mso-line-height-r=
ule: exactly;"><td id=3D"layout-row-padding489" valign=3D"top" style=3D"mso=
...
=3D"layout-row-margin486" valign=3D"top" style=3D"mso-line-height-rule: exa=
...
86" class=3D"layout layout-row widget _widget_text style486" style=3D"mso-l=
ine-height-rule: exactly; margin: 0; padding: 0;"><td id=3D"layout-row-padd=
ing486" valign=3D"top" style=3D"mso-line-height-rule: exactly; padding: 5px=
;"><table width=3D"100%" border=3D"0" cellpadding=3D"0" cellspacing=3D"0" s=
tyle=3D"-ms-text-size-adjust: auto; -webkit-text-size-adjust: 100%; border-=
...
id=3D"text_div414" class=3D"td_text td_block" valign=3D"top" align=3D"left"=
...
=0A</td>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A<tr style=3D"mso-line-height-=
rule: exactly; background-color: #ffffff;"><td id=3D"layout-row-margin485" =
valign=3D"top" style=3D"mso-line-height-rule: exactly; padding: 5px; backgr=
ound-color: #ffffff;"><table width=3D"100%" border=3D"0" cellpadding=3D"0" =
cellspacing=3D"0" style=3D"-ms-text-size-adjust: auto; -webkit-text-size-ad=
just: 100%; border-collapse: initial !important; font-size: 14px; min-width=
: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr id=3D"layout-row=
485" class=3D"layout layout-row widget _widget_text style485" style=3D"mso-=
line-height-rule: exactly; margin: 0; padding: 0; background-color: #244df0=
;"><td id=3D"layout-row-padding485" valign=3D"top" style=3D"mso-line-height=
-rule: exactly; background-color: #244df0; padding: 5px;"><table width=3D"1=
00%" border=3D"0" cellpadding=3D"0" cellspacing=3D"0" style=3D"-ms-text-siz=
e-adjust: auto; -webkit-text-size-adjust: 100%; border-collapse: collapse; =
font-size: 14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: =
0pt;"><tr=0Astyle=3D"mso-line-height-rule: exactly;"><td id=3D"text_div413"=
 class=3D"td_text td_block" valign=3D"top" align=3D"left" width=3D"630" sty=
le=3D"mso-line-height-rule: exactly; margin: 0; outline: none; padding: 0; =
color: inherit; font-size: 12px; font-weight: inherit; line-height: 1; text=
-decoration: inherit; font-family: arial;"> <div style=3D"margin: 0; outlin=
...
d>=0A</tr>=0A<tr id=3D"layout-row483" class=3D"layout layout-row clear-this=
 " style=3D"mso-line-height-rule: exactly; background-color: #ffffff;"><td =
id=3D"layout-row-padding483" valign=3D"top" style=3D"mso-line-height-rule: =
...
o-line-height-rule: exactly;"><td id=3D"layout_table_f1d6f04fdbb516c47ef2d3=
c61a4071a85ac769c7" valign=3D"top" width=3D"325" style=3D"mso-line-height-r=
...
le=3D"mso-line-height-rule: exactly;"><td=0Aid=3D"layout-row-margin484" val=
...
size: 14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"=
><tr id=3D"layout-row484" class=3D"layout layout-row widget _widget_spacer =
" style=3D"mso-line-height-rule: exactly;"><td id=3D"layout-row-padding484"=
...
ght-rule: exactly;"><td id=3D"layout-row-margin481" valign=3D"top" style=3D=
...
ont-size: 14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0=
pt;"><tr id=3D"layout-row481" class=3D"layout layout-row widget _widget_tex=
t style481" style=3D"mso-line-height-rule: exactly; margin: 0; padding: 0;"=
><td id=3D"layout-row-padding481" valign=3D"top" style=3D"mso-line-height-r=
ule: exactly; padding: 5px;"><table width=3D"100%" border=3D"0" cellpadding=
=3D"0" cellspacing=3D"0" style=3D"-ms-text-size-adjust: auto; -webkit-text-=
size-adjust: 100%; border-collapse: collapse; font-size: 14px; min-width: 1=
00%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr style=3D"mso-line-h=
eight-rule: exactly;"><td id=3D"text_div410" class=3D"td_text td_block" val=
...
_table_dcae5d6c1e016c9a4dcb14b0c3db9ab864f22605" valign=3D"top" width=3D"32=
...
apse: collapse; font-size: 14px; min-width: 100%; mso-table-lspace: 0pt; ms=
o-table-rspace: 0pt;"><tr style=3D"mso-line-height-rule: exactly;"><td id=
=3D"layout-row-margin482" valign=3D"top" style=3D"mso-line-height-rule: exa=
...
der-collapse: collapse; font-size: 14px; min-width: 100%; mso-table-lspace:=
 0pt; mso-table-rspace: 0pt;"><tr id=3D"layout-row482" class=3D"layout layo=
ut-row widget _widget_picture " align=3D"center" style=3D"mso-line-height-r=
ule: exactly;"><td id=3D"layout-row-padding482" valign=3D"top" style=3D"mso=
...
af.jpeg?id=3D7317250?r=3D1188364512" alt=3D"" width=3D"259" style=3D"displa=
y: block; border: none; outline: none; width: 259px; opacity: 1; max-width:=
 100%;"></td>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A</table>=0A</td>=0A</tr>=
=0A</table>=0A</td>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A<tr style=3D"mso-l=
ine-height-rule: exactly; background-color: #ffffff;"><td id=3D"layout-row-=
margin480" valign=3D"top" style=3D"mso-line-height-rule: exactly; padding: =
...
"layout-row480" class=3D"layout layout-row widget _widget_button style480" =
style=3D"mso-line-height-rule: exactly; background-color: #244df0;"><td id=
=3D"layout-row-padding480" valign=3D"top" style=3D"mso-line-height-rule: ex=
...
g=3D=3D&sig=3DChWyjhaYqAPfQwffD4yUoaPSBicyKKUTRYMF9n15nz4a&iat=3D1635284506=
...
s=3D0ad92c0c4a2ff86eed94873b1c9268b7&i=3D15A21A1A42" style=3D"v-text-anchor=
...
0lMkZzYnJ1Z21hbg=3D=3D&sig=3DChWyjhaYqAPfQwffD4yUoaPSBicyKKUTRYMF9n15nz4a&i=
at=3D1635284506&a=3D%7C%7C225362583%7C%7C&account=3Dmotorcityfunding%2Eacti=
vehosted%2Ecom&email=3DrcnACfXAw2TQUyfpj7YMwBdIU0DsLaDSPK6rhDqV%2BUXVt3QtV0=
xSM9W6AkIVKsAf&s=3D0ad92c0c4a2ff86eed94873b1c9268b7&i=3D15A21A1A42" style=
...
r>=0A</table>=0A</td>=0A</tr>=0A<tr style=3D"mso-line-height-rule: exactly;=
 background-color: #ffffff;"><td id=3D"layout-row-margin479" valign=3D"top"=
...
ble-lspace: 0pt; mso-table-rspace: 0pt;"><tr id=3D"layout-row479" class=3D"=
layout layout-row widget _widget_text style479" style=3D"mso-line-height-ru=
le: exactly; margin: 0; padding: 0;"><td id=3D"layout-row-padding479" valig=
...
v408"=0Aclass=3D"td_text td_block" valign=3D"top" align=3D"left" width=3D"6=
...
></div>=0A </div>=0A</td>=0A</tr>=0A</table>=0A</td>=0A</tr>=0A</table>=0A<=
/td>=0A</tr>=0A<tr id=3D"layout-row478" class=3D"layout layout-row clear-th=
is " style=3D"mso-line-height-rule: exactly; background-color: #ffffff;"><t=
d id=3D"layout-row-padding478" valign=3D"top" style=3D"mso-line-height-rule=
: exactly; background-color: #ffffff;"><table width=3D"100%" border=3D"0" c=
ellpadding=3D"0" cellspacing=3D"0" style=3D"-ms-text-size-adjust: auto; -we=
bkit-text-size-adjust: 100%; border-collapse: collapse; font-size: 14px; mi=
n-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr style=3D"=
mso-line-height-rule: exactly;"><td id=3D"layout_table_3b0c851c5b3b0c7e94c2=
a435619572585a30220d" valign=3D"top" width=3D"425" style=3D"mso-line-height=
-rule: exactly;"><table cellpadding=3D"0" cellspacing=3D"0" border=3D"0" cl=
ass=3D"layout layout-table " width=3D"425" style=3D"-ms-text-size-adjust: a=
uto; -webkit-text-size-adjust: 100%; border-collapse: collapse; font-size: =
14px; min-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr s=
tyle=3D"mso-line-height-rule: exactly;"><td=0Aid=3D"layout-row-margin475" v=
...
t; mso-table-rspace: 0pt;"><tr id=3D"layout-row475" class=3D"layout layout-=
row widget _widget_text style475" style=3D"mso-line-height-rule: exactly; m=
argin: 0; padding: 0; background-color: #244df0;"><td id=3D"layout-row-padd=
ing475" valign=3D"top" style=3D"mso-line-height-rule: exactly; background-c=
olor: #244df0; padding: 5px;"><table width=3D"100%" border=3D"0" cellpaddin=
g=3D"0" cellspacing=3D"0" style=3D"-ms-text-size-adjust: auto; -webkit-text=
-size-adjust: 100%; border-collapse: collapse; font-size: 14px; min-width: =
100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr style=3D"mso-line-=
height-rule: exactly;"><td id=3D"text_div405" class=3D"td_text td_block" va=
...
table_e5ff515d6e05e08f246b566a26a84be2d32156f0" valign=3D"top" width=3D"225=
...
apse: collapse; font-size: 14px; min-width: 100%; mso-table-lspace: 0pt; ms=
o-table-rspace: 0pt;"><tr style=3D"mso-line-height-rule: exactly;"><td id=
=3D"layout-row-margin477" valign=3D"top" style=3D"mso-line-height-rule: exa=
ctly; padding: 8px;"><table width=3D"100%" border=3D"0" cellpadding=3D"0" c=
ellspacing=3D"0" style=3D"-ms-text-size-adjust: auto; -webkit-text-size-adj=
ust: 100%; border-collapse: initial !important; font-size: 14px; min-width:=
 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;"><tr id=3D"layout-row4=
77" class=3D"layout layout-row widget _widget_button style477" style=3D"mso=
-line-height-rule: exactly; background-color: #244df0;"><td id=3D"layout-ro=
w-padding477" valign=3D"top"=0Astyle=3D"mso-line-height-rule: exactly; back=
...
lnc.com/Prod/link-tracker?nl=3D1&c=3D15&m=3D21&s=3D0ad92c0c4a2ff86eed94873b=
...
g.activehosted.com/proc.php?nl=3D1&c=3D15&m=3D21&s=3D0ad92c0c4a2ff86eed9487=
